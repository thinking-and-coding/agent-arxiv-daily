<p align="center">
  <h1 align="center"><br><ins>agent-ARXIV-DAILY</ins><br>Automatically Update Agent Papers Daily using Github Actions</h1>
</p>
...
This repository hosts the source code for agent-arxiv-daily, an useful sripts to fetch arxiv paper daily. 
...
2. Edit configs:
    - Change `GITHUB_USER_NAME` and `GITHUB_USER_EMAIL` in [cv-arxiv-daily.yml](../.github/workflows/agent-arxiv-daily.yml) and [update_paper_links.yml](../.github/workflows/update_paper_links.yml)
